classdef QuadPlot < handle
    ...
    methods
        % Constructor
        function Q = QuadPlot(qn, state, wingspan, height, ~, max_iter, h_3d)
            Q.qn = qn;
            Q.state = state;
            Q.wingspan = wingspan;
            Q.color = 'k';
        ...
        function UpdateQuadPlot(Q, state, des_state, time)
            ...
            drawnow;
            if Q.wingspan<0.7
                Q.wingspan = Q.wingspan*1.03;
                Q.height = Q.height*1.03;
            elseif Q.wingspan<1.2
                Q.wingspan = Q.wingspan*1.01;
                Q.height = Q.height*1.01;
            end
